...
BEGIN
  RETURN format('CREATE OR REPLACE TRIGGER %1$I
    ...
    FOR EACH ROW
    EXECUTE FUNCTION %2$I.%4$I ();',
      temporal_tables.fmt_trigger_name(in_temporal_table_name), in_schema_name,
...
BEGIN
  RETURN format('DROP TRIGGER %1$I ON %2$I.%3$I;',
    temporal_tables.fmt_trigger_name(in_temporal_table_name), in_schema_name,
    in_temporal_table_name);
END;
