...
CREATE TABLE gwapese.profession_name (
  ...
  CONSTRAINT profession_name_pk PRIMARY KEY (app_name, lang_tag, original, profession_id),
  CONSTRAINT profession_name_u UNIQUE (app_name, lang_tag, profession_id),
...
CREATE TABLE gwapese.profession_name_context (
  ...
  CONSTRAINT profession_name_context_pk PRIMARY KEY (app_name,
    original_lang_tag, translation_lang_tag, profession_id),
  CONSTRAINT profession_name_sources_context_fk FOREIGN KEY (app_name,
    original_lang_tag, original, profession_id) REFERENCES
    gwapese.profession_name (app_name, lang_tag, original, profession_id) ON
